...
(
    mkcd download
    curl -L https://github.com/embree/embree/releases/download/v3.2.0/embree-3.2.0.x86_64.linux.tar.gz -O
    tar xfz embree-3.2.0.x86_64.linux.tar.gz -C ../install --wildcards 'embree-3.2.0.x86_64.linux/*' --strip-components=1
